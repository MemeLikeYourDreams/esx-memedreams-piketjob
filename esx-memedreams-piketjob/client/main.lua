			...
			if Config.MaxInService ~= -1 then
				...
				ESX.TriggerServerCallback('esx_service:isInService', function(isInService)
					if isInService then
						...
						TriggerEvent('esx_policejob2:updateBlip')
  ...
  if Config.EnableArmoryManagement then
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('esx_policejob2:giveWeapon', weapon,  1000)
      end,
      function(data, menu)
...
function OpenPoliceActionsMenu()
	...
	ESX.UI.Menu.Open(
	'default', GetCurrentResourceName(), 'police_actions2',
	{
		title    = 'Piket',
		align    = 'top-left',
		elements = {
			...
			'default', GetCurrentResourceName(), 'citizen_interaction',
			{
				...
				if closestPlayer ~= -1 and closestDistance <= 3.0 then
					...
					elseif action == 'body_search' then
						TriggerServerEvent('esx_policejob2:message', GetPlayerServerId(closestPlayer), _U('being_searched'))
						OpenBodySearchMenu(closestPlayer)
					elseif action == 'handcuff' then
						TriggerServerEvent('esx_policejob2:handcuff', GetPlayerServerId(closestPlayer))
					elseif action == 'drag' then
						TriggerServerEvent('esx_policejob2:drag', GetPlayerServerId(closestPlayer))
					elseif action == 'put_in_vehicle' then
						TriggerServerEvent('esx_policejob2:putInVehicle', GetPlayerServerId(closestPlayer))
					elseif action == 'out_the_vehicle' then
						TriggerServerEvent('esx_policejob2:OutVehicle', GetPlayerServerId(closestPlayer))
...
function OpenIdentityCardMenu(player)
	...
	ESX.TriggerServerCallback('esx_policejob2:getOtherPlayerData', function(data)
	...
	ESX.TriggerServerCallback('esx_policejob2:getOtherPlayerData', function(data)
		...
		function(data, menu)
			...
			if data.current.value ~= nil then
				TriggerServerEvent('esx_policejob2:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
...
function OpenFineCategoryMenu(player, category)
  ...
  ESX.TriggerServerCallback('esx_policejob2:getFineList', function(fines)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if Config.EnablePlayerManagement then
          TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_police2', _U('fine_total', label), amount)
        else
...
function LookupVehicle()
	ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'lookup_vehicle',
	{
		...
		if data.value == nil or length < 2 or length > 13 then
			...
			ESX.TriggerServerCallback('esx_policejob2:getVehicleFromPlate', function(owner, found)
				if found then
...
function ShowPlayerLicense(player)
	...
	ESX.TriggerServerCallback('esx_policejob2:getOtherPlayerData', function(data)
		...
		function(data, menu)
			...
			TriggerServerEvent('esx_policejob2:message', GetPlayerServerId(player), _U('license_revoked', data.current.label))
...
function OpenVehicleInfosMenu(vehicleData)
	...
	ESX.TriggerServerCallback('esx_policejob2:getVehicleInfos', function(retrivedInfo)
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_policejob2:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_policejob2:removeArmoryWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_policejob2:addArmoryWeapon', function()
        OpenPutWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_policejob2:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_policejob2:buy', function(hasEnoughMoney)
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_policejob2:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              menu2.close()
              menu.close()
              TriggerServerEvent('esx_policejob2:getStockItem', itemName, count)
...
function OpenPutStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_policejob2:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              menu2.close()
              menu.close()
              TriggerServerEvent('esx_policejob2:putStockItems', itemName, count)
...
AddEventHandler('esx:setJob', function(job)
	...
	Citizen.Wait(5000)
	TriggerServerEvent('esx_policejob2:forceBlip')
end)
...
AddEventHandler('esx_policejob2:hasEnteredMarker', function(station, part, partNum)
...
AddEventHandler('esx_policejob2:hasExitedMarker', function(station, part, partNum)
  ESX.UI.Menu.CloseAll()
  CurrentAction = nil
end)
...
AddEventHandler('esx_policejob:hasEnteredEntityZone', function(entity)
  ...
  if PlayerData.job ~= nil and PlayerData.job.name == 'police2' and not IsPedInAnyVehicle(playerPed, false) then
...
AddEventHandler('esx_policejob2:hasExitedEntityZone', function(entity)
...
RegisterNetEvent('esx_policejob2:handcuff')
AddEventHandler('esx_policejob2:handcuff', function()
...
RegisterNetEvent('esx_policejob2:unrestrain')
AddEventHandler('esx_policejob2:unrestrain', function()
	if IsHandcuffed then
		local playerPed = PlayerPedId()
		IsHandcuffed = false
...
RegisterNetEvent('esx_policejob2:drag')
AddEventHandler('esx_policejob2:drag', function(copID)
...
RegisterNetEvent('esx_policejob2:putInVehicle')
AddEventHandler('esx_policejob2:putInVehicle', function()
	local playerPed = PlayerPedId()
	local coords    = GetEntityCoords(playerPed)
...
RegisterNetEvent('esx_policejob2:OutVehicle')
AddEventHandler('esx_policejob2:OutVehicle', function()
	local playerPed = PlayerPedId()
  ...
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'police2' then
      ...
      for k,v in pairs(Config.PoliceStations) do
        ...
        if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.name == 'police2' and PlayerData.job.grade_name == 'boss' then
  ...
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'police2' then
      ...
      if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum) ) then
        ...
        then
          TriggerEvent('esx_policejob2:hasExitedMarker', LastStation, LastPart, LastPartNum)
          hasExited = true
        end
        ...
        TriggerEvent('esx_policejob2:hasEnteredMarker', currentStation, currentPart, currentPartNum)
      end
  ...
  while true do
    ...
    if closestDistance ~= -1 and closestDistance <= 3.0 then
      ...
      if LastEntity ~= closestEntity then
        TriggerEvent('esx_policejob2:hasEnteredEntityZone', closestEntity)
      ...
      if LastEntity ~= nil then
        TriggerEvent('esx_policejob2:hasExitedEntityZone', LastEntity)
        LastEntity = nil
      end
...
Citizen.CreateThread(function()
	while true do
		...
		if CurrentAction ~= nil then
			...
			if IsControlJustReleased(0, Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'police2' then
				...
				elseif CurrentAction == 'delete_vehicle' then
					if Config.EnableSocietyOwnedVehicles then
						...
						TriggerServerEvent('esx_society:putVehicleInGarage', 'police2', vehicleProps)
					end
					ESX.Game.DeleteVehicle(CurrentActionData.vehicle)
				elseif CurrentAction == 'menu_boss_actions' then
					ESX.UI.Menu.CloseAll()
					TriggerEvent('esx_society:openBossMenu', 'police2', function(data, menu)
						menu.close()
						CurrentAction     = 'menu_boss_actions'
						CurrentActionMsg  = _U('open_bossmenu')
						CurrentActionData = {}
		...
		if IsControlJustReleased(0, Keys['F6']) and not isDead and PlayerData.job ~= nil and PlayerData.job.name == 'police2' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'police_actions2') then
			if Config.MaxInService == -1 then
...
RegisterNetEvent('esx_policejob2:updateBlip')
AddEventHandler('esx_policejob2:updateBlip', function()
	...
	if PlayerData.job ~= nil and PlayerData.job.name == 'police2' then
		ESX.TriggerServerCallback('esx_society:getOnlinePlayers', function(players)
			for i=1, #players, 1 do
				if players[i].job.name == 'police2' then
...
AddEventHandler('playerSpawned', function(spawn)
	isDead = false
	TriggerEvent('esx_policejob2:unrestrain')
	
	if not hasAlreadyJoined then
		TriggerServerEvent('esx_policejob2:spawned')
	end
